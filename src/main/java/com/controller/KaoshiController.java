...
//                            kaoshiEntity.setJiaoshiId(Integer.valueOf(data.get(0)));   //教师 要改的
//                            kaoshiEntity.setBanjiTypes(Integer.valueOf(data.get(0)));   //班级 要改的
//                            kaoshiEntity.setKaoshiUuidNumber(data.get(0));                    //考试编号 要改的
//                            kaoshiEntity.setKaoshiName(data.get(0));                    //考试名称 要改的
//                            kaoshiEntity.setKaoshiNian(data.get(0));                    //年 要改的
//                            kaoshiEntity.setKaoshiTypes(Integer.valueOf(data.get(0)));   //学期 要改的
