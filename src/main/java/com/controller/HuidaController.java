    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(huida !=null){
            ...
            BeanUtils.copyProperties( huida , view );//把实体数据重构到view中
                ...
                //级联表
                JiazhangxueshengEntity jiazhangxuesheng = jiazhangxueshengService.selectById(huida.getJiazhangxueshengId());
    ...
    */
    ...
    public R save(@RequestBody HuidaEntity huida, HttpServletRequest request){
        ...
        if(false)
            ...
            huida.setJiazhangxueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<HuidaEntity> queryWrapper = new EntityWrapper<HuidaEntity>()
            .eq("zuoye_id", huida.getZuoyeId())
            .eq("jiazhangxuesheng_id", huida.getJiazhangxueshengId())
            ;
...
//                            huidaEntity.setJiazhangxueshengId(Integer.valueOf(data.get(0)));   //家长学生 要改的
